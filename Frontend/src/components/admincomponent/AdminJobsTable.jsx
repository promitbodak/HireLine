...
import { Edit2, Eye, MoreHorizontal, ChartPie } from "lucide-react";
                ...
                <TableCell className="text-right cursor-pointer">
                  <Popover>
                    ...
                    <PopoverContent className="w-32">
                      ...
                      <hr />
                      <div onClick={() => navigate(`/admin/jobs/${job._id}/analytics`)} className="flex items-center gap-2 w-fit cursor-pointer mt-1">
                        <ChartPie className="w-4"></ChartPie>
                        <span>Analytics</span>
                      </div>
                    </PopoverContent>
                  </Popover>
